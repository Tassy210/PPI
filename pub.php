...
$sql1= "insert into postagens(texto, data, nome_do_usuario) values ('$texto', '$data', ".$_SESSION['usuario'].")";
$query1=mysqli_query($conexao, $sql1 );

$sql2="select* from postagem where id_user=".$_SESSION['usuario']." order by id desc limit 1 ";
